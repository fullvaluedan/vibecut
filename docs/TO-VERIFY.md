...
- [ ] **Near-ties are NOT auto-cut** — two equally-good (equally loud) takes do NOT produce a destructive removal in this slice (they're held back; the modal UI to pick one manually is the next step, U7). Confirm you don't see a coin-flip take silently deleted on apply.
